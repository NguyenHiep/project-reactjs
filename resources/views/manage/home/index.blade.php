...
@section('title', __('Quản lý trang chủ'))
@section('description', __('Mô tả quản lý trang chủ'))
@section('content')
              ...
              <table class="table table-white mg-b-0 tx-12">
                ...
                <tr>
                  <td class="pd-l-20 tx-center">
                    <img src="{{ asset('/manages/img/img1.jpg')}}" class="wd-36 rounded-circle" alt="Image">
                  </td>
                  <td>
                ...
                <tr>
                  <td class="pd-l-20 tx-center">
                    <img src="{{ asset('/manages/img/img2.jpg')}}" class="wd-36 rounded-circle" alt="Image">
                  </td>
                  <td>
                ...
                <tr>
                  <td class="pd-l-20 tx-center">
                    <img src="{{ asset('/manages/img/img3.jpg')}}" class="wd-36 rounded-circle" alt="Image">
                  </td>
                  <td>
                ...
                <tr>
                  <td class="pd-l-20 tx-center">
                    <img src="{{ asset('/manages/img/img5.jpg')}}" class="wd-36 rounded-circle" alt="Image">
                  </td>
                  <td>
                ...
                <tr>
                  <td class="pd-l-20 tx-center">
                    <img src="{{ asset('/manages/img/img4.jpg')}}" class="wd-36 rounded-circle" alt="Image">
                  </td>
                  <td>
