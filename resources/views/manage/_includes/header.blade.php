...
<head>
  ...
  <!-- vendor css -->
  <link href="{{ asset('/manages/lib/font-awesome/css/font-awesome.css')}}" rel="stylesheet">
  <link href="{{ asset('/manages/lib/Ionicons/css/ionicons.css')}}" rel="stylesheet">
  <link href="{{ asset('/manages/lib/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet">
  <link href="{{ asset('/manages/lib/jquery-toggles/toggles-full.css')}}" rel="stylesheet">
  <link href="{{ asset('/manages/lib/rickshaw/rickshaw.min.css')}}" rel="stylesheet">
  
  <!-- Amanda CSS -->
  <link rel="stylesheet" href="{{ asset('/manages/css/amanda.css')}}">
</head>
  ...
  <div class="am-header-right">
        ...
        <div class="media-list">
          ...
          <a href="" class="media-list-link read">
            <div class="media pd-x-20 pd-y-15">
              <img src="{{ asset('/manages/img/img8.jpg')}}" class="wd-40 rounded-circle" alt="">
          ...
          <a href="" class="media-list-link read">
            <div class="media pd-x-20 pd-y-15">
              <img src="{{ asset('/manages/img/img9.jpg')}}" class="wd-40 rounded-circle" alt="">
              <div class="media-body">
          ...
          <a href="" class="media-list-link read">
            <div class="media pd-x-20 pd-y-15">
              <img src="{{ asset('/manages/img/img10.jpg')}}" class="wd-40 rounded-circle" alt="">
              <div class="media-body">
          ...
          <a href="" class="media-list-link read">
            <div class="media pd-x-20 pd-y-15">
              <img src="{{ asset('/manages/img/img5.jpg')}}" class="wd-40 rounded-circle" alt="">
              <div class="media-body">
    ...
    <div class="dropdown dropdown-profile">
      <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
        <img src="{{ asset('/manages/img/img3.jpg')}}" class="wd-32 rounded-circle" alt="">
      ...
      <div class="dropdown-menu wd-200">
        <ul class="list-unstyled user-profile-nav">
          ...
          <li>
            <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="icon ion-power"></i> Đăng xuất</a>
      ...
      <div class="list-group list-group-chat">
        <a href="#" class="list-group-item">
          <div class="d-flex align-items-center">
            <img src="{{ asset('/manages/img/img6.jpg')}}" class="wd-32 rounded-circle" alt="">
            <div class="mg-l-10">
        ...
        <a href="#" class="list-group-item">
          <div class="d-flex align-items-center">
            <img src="{{ asset('/manages/img/img7.jpg')}}" class="wd-32 rounded-circle" alt="">
            <div class="mg-l-10">
              <h6>James F. Sears</h6>
        ...
        <a href="#" class="list-group-item">
          <div class="d-flex align-items-center">
            <img src="{{ asset('/manages/img/img8.jpg')}}" class="wd-32 rounded-circle" alt="">
            <div class="mg-l-10">
              <h6>Sharon R. Rowe</h6>
        ...
        <a href="#" class="list-group-item">
          <div class="d-flex align-items-center">
            <img src="{{ asset('/manages/img/img9.jpg')}}" class="wd-32 rounded-circle" alt="">
            <div class="mg-l-10">
              <h6>Ruby M. Martin</h6>
              <span>Sunday, 7:45pm</span>
            </div>
        ...
        <a href="#" class="list-group-item">
          <div class="d-flex align-items-center">
            <img src="{{ asset('/manages/img/img10.jpg')}}" class="wd-32 rounded-circle" alt="">
            <div class="mg-l-10">
              <h6>Joslyn C. Mayo</h6>
              <span>Sunday, 7:45pm</span>
            </div>
